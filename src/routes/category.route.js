...
const { get_all_category, create_category, edit_category, delete_category, edit_delete_category, get_category } = require('../controllers/category.controller');

const router = express.Router();

router.get('/', get_all_category);
router.get('/:_id', get_category);
